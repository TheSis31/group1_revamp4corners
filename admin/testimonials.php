...
if(isset($_GET['delete_id']))
{
	...
	if($now_delete){
		...
		<script>window.location.href = 'testimonials.php'</script>";
	}else{
	    $query_delete="DELETE FROM testimonials WHERE id='".$_GET['delete_id']."'";
		$p = mysqli_query($con, $query_delete);
		echo "<script>alert('Deleted Successfully');</script>
    ...
    <section class="content">
      <div class="row">
				  ...
				  <tr>
                    ...
                    <td class="text-right py-0 align-middle">
                      <div class="btn-group btn-group-sm">
                        ...
                        <a href="testimonials.php?delete_id=<?php echo $roww["id"]; ?>" onclick="return confirm('Are you sure?')" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                      </div>
                    </td>
                </tr>
			<?php 
		...
		for ($i=1; $i<=$total_pages; $i++) {
					  $pagLink .= "<li class='page-item'><a class='page-link' href='testimonials.php?page=".$i."'>".$i."</a></li>";	
		}
		echo $pagLink . "</ul>";  
		?>
            <!-- /.card-body -->
